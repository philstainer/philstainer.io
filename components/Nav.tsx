...
export const Nav = (): JSX.Element => {
  return (
    <nav className="sticky top-0 z-10 flex items-center justify-end w-full max-w-5xl p-6 mx-auto my-0 bg-white opacity-95 select-none dark:bg-gray-900 md:my-2">
